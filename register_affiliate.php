                        ...
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                <div class="col-md-12 form-group p_star">
                                    ...
                                    <input type="text" class="form-control" id="name" name="fullname" value="" placeholder="Full name">
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <label for="">Email or Number</label>
                                    <input type="text" class="form-control" id="name" name="email" value="" placeholder="Email or Phone number">
                                </div>
                                <div class="col-md-12 form-group p_star">
