                        ...
                        <div class="table-responsive table-borderless">
                            <table class="table">
                                ...
                                <tbody class="table-body">
                                    <?php foreach($ordered_details as $all_details){
                                    ...
                                    <tr class="cell-1">
                                        ...
                                        <td><span
                                                class="badge badge-success"><?php if($all_details['status'] == 0){
                                            echo "Dispatched";
                                        }elseif($all_details['status'] == 1){ echo "On the way";}elseif($all_details['status']==2){ echo "Delivered";} ?></span>
                                        </td>
