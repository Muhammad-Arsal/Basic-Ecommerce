        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-lx-4">
            <div class="single_confirmation_details">
              ...
              <ul>
                <li>
                  <p>Order number</p><span>: <?php echo $data['order_number'] ?></span>
                </li>
                <li>
                  <p>Date</p><span>: <?php echo  $data['date']; ?></span>
                </li>
                <li>
          ...
          <div class="col-lg-6 col-lx-4">
            <div class="single_confirmation_details">
              ...
              <ul>
                <li>
                  <p>city</p><span>: <?php echo $data['city'] ?></span>
                </li>
                <li>
                  <?php
                  $id = $data['country_id'];
                  $country = select_where("country_name", "id", $id, $connection, 1);
                  ?>
                  <p>country</p><span>:<?php echo $country['name']; ?></span>
                </li>
                <li>
                  <p>postcode</p><span>: <?php echo $data['postal_code'] ?></span>
                </li>
              </ul>
            </div>
          </div>
