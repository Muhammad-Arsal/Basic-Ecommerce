    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown" id="noti">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                <span class="badge badge-warning navbar-badge show_number"><?php echo $number_of_notification; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="menu">
                <?php
                for ($i = 1; $i <= $number_of_notification; $i++) {
                ?>
                    <a href="./orders.php"><span class="dropdown-item dropdown-header new_notification">***1 new order***</span></a>
                <?php
                }
                ?>
                <!-- <div class="dropdown-divider"></div> -->
