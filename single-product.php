      ...
      <div class="row s_product_inner justify-content-between">
        ...
        <div class="col-lg-5 col-xl-4">
          <div class="s_product_text">
            ...
            <h2><?php if (!empty($seller_prod_val['sale_price'])) {
                  echo $seller_prod_val['sale_price'] . "$";
                } else {
                  echo "0";
                }  ?></h2>
            <ul class="list">
              ...
              <li>
                <a href="#"> <span>Availibility</span> :<?php if (!empty($seller_prod_val['stock'])) {
                                                          echo $seller_prod_val['stock'] . "pieces";
                                                        } else {
                                                          echo "0 pieces";
                                                        }  ?></a>
              </li>
